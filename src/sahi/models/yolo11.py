...
class Yolo11DetectionModel(DetectionModel):
    ...
    def load_model(self):
        ...
        try:
            ...
            raise TypeError("model_path is not a valid yolo11 model path: ", e)

    def set_model(self, model: Any):
        """
        Sets the underlying Yolo11 model.
        Args:
            model: Any
                A Yolo11 model
        """
    ...
    def perform_inference(self, image: np.ndarray):
        ...
        prediction_result = self.model(image[:, :, ::-1], **kwargs)  # Yolo11 expects numpy arrays to have BGR
